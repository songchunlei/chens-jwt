package org.chens.jwt.vo;

import io.jsonwebtoken.Claims;
import io.jsonwebtoken.RequiredTypeException;
import io.jsonwebtoken.impl.JwtMap;
import org.chens.jwt.JwtConstants;
...
public class UAAClaims extends JwtMap implements Claims {
    ...
    public void setScope(String[] scope) {
        this.scope = scope;
        setValue(JwtConstants.JWT_TOKEN_SCOPE, this.scope);
    }
    ...
    public void setGrantType(String grantType) {
        ...
        setValue(JwtConstants.JWT_TOKEN_GRANTTYPE, this.grantType);
    }
    ...
    public void setUserName(String userName) {
        ...
        setValue(JwtConstants.JWT_TOKEN_USERNAME, this.userName);
    }
    ...
    public void setTenantId(String tenantId) {
        ...
        setValue(JwtConstants.JWT_TOKEN_TENANTID, this.tenantId);
    }
    ...
    public void setUser(String user) {
        this.user = user;
        setValue(JwtConstants.JWT_TOKEN_USER, this.user);
    }
